...
from src.chunking import FixedSizeChunker, PolicyStructureChunker, RecursiveChunker, SentenceChunker
...
QUERIES = [
    BenchmarkQuery(
        ...
        gold_doc_ids=("shopee-article-188931", "shopee-article-77251"),
    ...
    BenchmarkQuery(
        ...
        gold_doc_ids=("shopee-article-189473",),
    ...
    BenchmarkQuery(
        ...
        gold_doc_ids=("shopee-article-189477", "shopee-article-77251"),
    ...
    BenchmarkQuery(
        ...
        gold_doc_ids=("shopee-article-79467",),
    ...
    BenchmarkQuery(
        ...
        gold_doc_ids=("shopee-article-79508",),
...
def build_strategies(chunk_size: int, overlap: int, sentences: int) -> dict[str, object]:
    return {
        ...
        "policy_structure": PolicyStructureChunker(chunk_size=450, max_sentences=2),
    }
...
def render_report(payload: dict) -> str:
    lines = [
        ...
        "Tuned policy_structure: chunk_size=450, max_sentences=2, lap lai tieu de tai lieu",
        "",
        "BANG TONG HOP",
